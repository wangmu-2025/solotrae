...
public class RandomPracticeActivity extends AppCompatActivity {
    ...
    private void startPractice() {
        ...
        // 传递练习模式
        intent.putExtra(PracticeModeSelectActivity.EXTRA_MODE, PracticeModeSelectActivity.MODE_RANDOM);
        
        // 启动Activity
        startActivity(intent);
        
        // 显示开始练习提示
        Toast.makeText(this, "开始随机练习", Toast.LENGTH_SHORT).show();
    }
}